  ...
  <div id="login">
    ...
    <el-form ref="userForm" :hide-required-asterisk="false" :model="form" label-width="80px" :rules="rules">
      ...
      <el-form-item style="padding-left:40px; padding-top: 10px ">
        <el-button type="primary" @click="onSubmit('userForm')">注册</el-button>
        <el-button @click="reset()">重置</el-button>
        <a style="background-color:white; color: black" href="#/login">已有账号点此登录</a>
      </el-form-item>
    </el-form>
      ...
      onSubmit() {
        this.$refs['userForm'].validate((valid) => {
          if (valid) {
            ...
            this.$http.post("http://39.106.86.151:8989/user/register", this.form).then(res =>{
